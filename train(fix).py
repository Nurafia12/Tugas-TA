...
featlist = ['Contrast', 'Dissimilarity', 'Homogeneity', 'Energy','Correlation','Kelas'] 
...
print("==============================")
print("Waktu yang diperlukan HH:MM:SS")
print(b-a)#menghitung waktu yang yang sudah berjalan 
print("==============================")
